...
molecs = [{'name': 'co_1',  'molec': 'CO', 'isotp': 0, 'comp': 5, 'intv': [2000., 2250.], 'c': 1.3, 'res': 0.1, 'T': 303., 'P': 1000., 'l': 0.025},
          ...
          {'name': 'co_c2', 'molec': 'CO', 'isotp': 0, 'comp': 5, 'intv': [2000., 2245.], 'c': 0.04, 'res': 0.1, 'T': 303., 'P': 1000., 'l': 3.00},
          {'name': 'co_c3', 'molec': 'CO', 'isotp': 0, 'comp': 5, 'intv': [2000., 2245.], 'c': 0.06, 'res': 0.1, 'T': 303., 'P': 1000., 'l': 3.00},
...
halirrunfile = "# This is a examples txt input for HalIR\n\
\n\
...
swin:  {intv[0]} {intv[1]} 0\n\
# What molecules to fit\n\
# molec is the name of the molecule\n\
# isotp is the isotopic composistion 0 for natural abundance otherwise use the 3 digit code from\n\
# hitran.par (column 5)\n\
# conc concentration\n\
...
maltrunfile = "!Demo MALT5 input file\n\
!=====================\n\
