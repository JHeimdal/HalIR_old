...
Hitran::Hitran()
{
    ...
    do {
        ...
        in.get(ctmp,11); hl.line_I=atof(ctmp);
        in.get(ctmp,11); hl.einstein_A=atof(ctmp);
        in.get(ctmp,6); hl.air_B=atof(ctmp);
        in.get(ctmp,6); hl.self_B=atof(ctmp);
        in.get(ctmp,11); hl.low_state_en=atof(ctmp);
        in.get(ctmp,5); hl.temp_air_B=atof(ctmp);
        in.get(ctmp,9); hl.pressure_S=atof(ctmp);
        ...
        in.get(ctmp,8); hl.u_stat_w=atof(ctmp);
        in.get(ctmp,8); hl.l_stat_w=atof(ctmp);
        in.ignore(8,'\n');
        hitpar.push_back(hl);
    } while( !in.eof() );
    hitpar.pop_back();
